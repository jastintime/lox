...
func newResolver(interpreter Interpreter) Resolver {
	...
	return Resolver{interpreter, stack, functionType.None}
}
...
// NOTE: error being emitted here for this test case
// NOTE: NEED TO VERIFY STACK IMPLEMENTATION
func (r Resolver) VisitVariableExpr(expr VariableExpr) any {
	// im expecting that its not empty and that expr.Name.Lexeme == true
	if !r.scopes.IsEmpty() {
